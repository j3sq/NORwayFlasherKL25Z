...
**     Date/Time   : 2014-10-12, 23:55, # CodeGen: 18
**     Abstract    :
...
**            Clock settings                               : 
**              Module clock source                        : External clock
**              Module clock frequency                     : USB_CLKIN
...
void USB0_Init(void)
{
 ...
 // SIM_SOPT2 &= (uint32_t)~(uinEncoder:  l,rt32_t)(SIM_SOPT2_USBSRC_MASK);                                   
  /* USB0_CTL: ODDRST=1 */
